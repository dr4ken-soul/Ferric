    ...
    <section className="border-t border-[var(--border-subtle)] bg-[var(--bg-primary)] px-4 py-24 md:px-8 md:py-32 lg:px-12">
      <div className="mx-auto grid max-w-[1400px] grid-cols-1 items-end gap-10 lg:grid-cols-12 lg:gap-8">
        <Reveal className="lg:col-span-7">
          ...
          <p className="mt-6 max-w-[52ch] font-body text-[15px] leading-[1.6] text-[var(--text-secondary)]">Clone the repository and the full suite passes against committed cassettes with no provider account and no network access.</p>
        </Reveal>
